...
![skills](https://skillicons.dev/icons?i=html,css,sass,js,ts,nodejs,vue,react,mongodb,mysql,py,vim,docker,kubernetes,md,git,figma,bash,nginx,aws,gcpvscode&theme=light)
